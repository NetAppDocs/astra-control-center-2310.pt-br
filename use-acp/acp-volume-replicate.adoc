...
.Clusters de ONTAP
* *Provisioner*: O Astra Control Provisioner versão 22,10 ou posterior deve existir nos clusters do Kubernetes de origem e destino que utilizam o ONTAP como um back-end.
